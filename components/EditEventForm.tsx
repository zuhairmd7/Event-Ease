...
export default function EditEventForm({ event, onClose }: EditEventFormProps) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg border-2 border-dashed border-[#dc8277]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex flex-row gap-2 justify-center">
                        <button type="submit" className="bg-[#dc8277] text-white font-bold flex justify-center text-center items-center px-3 py-2 rounded-md hover:bg-[#e26858]">
                            Update
                        </button>
                        <button type="button" onClick={onClose} className="bg-gray-500 text-white font-bold flex justify-center text-center items-center px-3 py-2 rounded-md hover:bg-gray-700">
                            Cancel
                        </button>
                    </div>
                </form>
